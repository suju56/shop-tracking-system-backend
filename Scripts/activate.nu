...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\OneDrive\Desktop\shop-tracking-system-backend'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\OneDrive\Desktop\shop-tracking-system-backend\Scripts\deactivate.nu'
